...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		<h4 class="page-title mb-0"><?php echo e(__('New Restaurant')); ?></h4>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">	
				<div class="card-header">
					<h3 class="card-title"><i class="fa-solid fa-signature mr-2 text-primary"></i><?php echo e(__('Restaurant Information')); ?></h3>
					<a href="<?php echo e(route('user.brand')); ?>" class="btn btn-cancel mr-2 pl-5 pr-5" style="margin-left: auto"><?php echo e(__('Back to Restaurants List')); ?></a>
				</div>			
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" placeholder="<?php echo e(__('Provide restaurant name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="website" name="website" placeholder="<?php echo e(__('Enter restaurant website URL')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="industry" name="industry" placeholder="<?php echo e(__('List your restaurant theme')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="tagline" name="tagline" placeholder="<?php echo e(__('Some ideas for your restaurant tagline')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="audience" name="audience" placeholder="<?php echo e(__('Describe the primary target audience for your restaurant')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/brand/create.blade.php ENDPATH**/ ?>