		...
		<div class="row justify-content-md-center">	
			<div class="col-sm-12 text-center">
				<h3 class="card-title fs-20 mb-3 super-strong">
				   <span class="fs-18 fa-solid  fa-kitchen-set"></span>
				  <?php echo e(__('Kitchen AI FAQ')); ?>

				</h3>
				<h6 class="mb-0 fs-12 text-muted"><?php echo e(__('Effortlessly sift through your recipes, manuals, and inventory lists in Word, PDF, or CSV formats with the aid of AI.')); ?></h6>
					...
					<div class="card-footer">
						<div class="row text-center">						
							<div class="col-sm-12">		
								...
								<a class="btn btn-primary pl-6 pr-6 fs-12 mt-1" id="upload-pdf-button" href="javascript:void(0);"><?php echo e(__('Upload Document')); ?></a>
							</div>
						</div>
					</div>
				</div>
								...
								<div id="chat-container">
									<div class="msg left-msg" id="intro-drop-box">
										...
										<div class="message-bubble">					
											<div class="msg-text"><?php echo e(__('Hello! I can help you sift through your recipes, manuals, and inventory lists in Word, PDF, or CSV formats. What details are you looking to find?')); ?></div>
										</div>
									</div>
									<div id="image-drop-box">
										<div class="image-drop-area text-center">
											<div class="msg left-msg text-center mt-9">
												...
												<div class="message-bubble">					
													<div class="msg-text"><?php echo e(__('Hey there, ready to assist with analyzing your culinary documents. Share your files with me to begin!')); ?></div>
													<div class="msg-text"><?php echo e(__('Select and upload your documents to get started, and let\'s dive into your culinary data!')); ?></div>
												</div>
											</div>											
										</div>
									</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/chat_file/index.blade.php ENDPATH**/ ?>