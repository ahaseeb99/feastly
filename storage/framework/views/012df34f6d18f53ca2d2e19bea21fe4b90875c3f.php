...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		<h4 class="page-title mb-0"><?php echo e(__('Restaurant Brand')); ?></h4>
		<h6 class="text-muted">Whip up unique AI-generated content specially seasoned for your culinary brand,<br/> effortlessly infusing your core messages without the need for repetitive introductions.</h6>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><i class="fa-solid fa-signature mr-2 text-primary"></i><?php echo e(__('My Restaurant Brands')); ?></h3>
					<a href="<?php echo e(route('user.brand.create')); ?>" class="btn btn-primary ripple" style="margin-left: auto"><?php echo e(__('Add New Restaurant')); ?></a>
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/brand/index.blade.php ENDPATH**/ ?>