									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											...
											<select id="iyzico_sandbox" name="iyzico_sandbox" class="form-select">			
												<option value=1 <?php if(config('services.iyzico.sandbox')  == true): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
												<option value=0 <?php if(config('services.iyzico.sandbox')  == false): ?> selected <?php endif; ?>><?php echo e(__('Disable')); ?></option>
											</select>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/2checkout.webp')); ?>" alt="2Checkout" class="gateway-logo"><span class="text-primary">2Checkout</span> <?php echo e(__('Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>

								<div class="row">
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												<input type="checkbox" name="enable-2checkout" class="custom-switch-input" <?php if(config('services.2checkout.enable')  == 'on'): ?> checked <?php endif; ?>>
												<span class="custom-switch-indicator"></span>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												<input type="checkbox" name="enable-2checkout-subscription" class="custom-switch-input" <?php if(config('services.2checkout.subscription')  == 'on'): ?> checked <?php endif; ?>>
												<span class="custom-switch-indicator"></span>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">
										...
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['2checkout_merchant_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="2checkout_merchant_code" name="2checkout_merchant_code" value="<?php echo e(config('services.2checkout.merchant_code')); ?>" autocomplete="off">
											</div>
											<?php $__errorArgs = ['2checkout_merchant_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('2checkout_merchant_code')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">								
										...
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['2checkout_secret_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="2checkout_secret_key" name="2checkout_secret_key" value="<?php echo e(config('services.2checkout.secret_key')); ?>" autocomplete="off">
											</div> 
											<?php $__errorArgs = ['2checkout_secret_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('2checkout_secret_key')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											...
											<select id="2checkout_sandbox" name="2checkout_sandbox" class="form-select">			
												<option value=true <?php if(config('services.2checkout.sandbox')  == true): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
												<option value=false <?php if(config('services.2checkout.sandbox')  == false): ?> selected <?php endif; ?>><?php echo e(__('Disable')); ?></option>
											</select>
											<?php $__errorArgs = ['2checkout_sandbox'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('2checkout_sandbox')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/admin/finance/settings/index.blade.php ENDPATH**/ ?>