		...
		<div class="col-xl-9 col-lg-12 col-md-12 col-sm-12">
			<div class="card border-0 pt-2">
				<div class="card-body">	
					...
					<form id="payment-form" action="<?php echo e(route('user.payments.pay.prepaid', ['type' => $type, 'id' => $id])); ?>" promocode="<?php echo e(route('user.payments.promocodes.prepaid', $id)); ?>" method="POST" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 pr-4">
								<div class="checkout-wrapper-box pb-0">									
										...
										<input type="hidden" name="value" id="hidden_value" value="<?php echo e($total_value); ?>">
								...
								<div class="checkout-wrapper-box">
									...
									<div class="input-box mb-5">
										<div class="input-group">								
											<input type="text" class="form-control border-right-0 promocode-field" name="promo_code" placeholder="<?php echo e(__('Promocode')); ?>">
											<label class="input-group-btn">
												<a class="btn btn-primary" id="prepaid-promocode-apply"><?php echo e(__('Apply')); ?></a>
											</label>											
										</div>
									...
									<div id="voucher-result" class="d-none">
										<p class="fs-12 p-family"><?php echo e(__('Discount Applied')); ?> </span><span class="checkout-cost"><span id="total_discount"></span></span></p>
									</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/plans/prepaid-checkout.blade.php ENDPATH**/ ?>