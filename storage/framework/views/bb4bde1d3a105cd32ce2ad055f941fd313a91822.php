	...
	<div class="row mt-24">
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="border-0 templates-nav-header">
				<div class="card-body">
					<div>
						<h3 class="card-title mb-3 ml-2 fs-20 super-strong"><i class="fa-solid fa-book mr-2 text-primary"></i><?php echo e(__('Cooking Templates')); ?></h3>
						<h6 class="text-muted mb-3 ml-2"><?php echo e(__('Seeking that perfect recipe? Look no further! Get ready to explore our delicious lineup of cooking templates.')); ?></h6>
						<?php if(config('settings.custom_templates') == 'anyone'): ?>
							<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-primary ripple" id="create-ai-button" style="text-transform: none;"><?php echo e(__('Create Custom Cooking Template')); ?></a>
						<?php else: ?>
							<?php if($check): ?>
								<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-primary ripple" id="create-ai-button" style="text-transform: none;"><?php echo e(__('Create Custom Cooking Template')); ?></a>
							<?php endif; ?>	
						...
						<div class="template-nav-menu-inner">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="true"><?php echo e(__('All Cooking Templates')); ?></button>
								</li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/templates/index.blade.php ENDPATH**/ ?>