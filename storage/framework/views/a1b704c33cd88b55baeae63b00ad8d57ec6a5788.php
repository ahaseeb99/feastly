							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">
									<div class="input-group file-browser">	
										...
										<input type="text" class="form-control border-right-0 browse-file" placeholder="<?php echo e(__('Include attachment file...')); ?>" style="margin-right: 80px;" readonly>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/support/create.blade.php ENDPATH**/ ?>