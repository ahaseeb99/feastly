...
<form id="wizard-form" action="" method="post" enctype="multipart/form-data" class="mt-24"> 		
	...
	<div class="row justify-content-center">	
		<div class="col-sm-12 text-center">
			<h3 class="card-title fs-20 mb-0 super-strong"><i class="fa-solid fa-kitchen-set mr-2 text-primary"></i><?php echo e(__('Cooking Article Wizard')); ?></h3>
			<p style="margin-top: 10px"  class="font-weight-semibold mt-10 ">Craft the perfect dish for your readers.</p>
					...
					<div class="row text-center justify-content-center">
						...
						<div class="col-3">
							<div class="d-flex wizard-nav-text">
								...
								<div class="wizard-step-title"><span class="font-weight-bold fs-14"><?php echo e(__('Points')); ?></span> <br> <span class="text-muted wizard-step-title-number fs-11 float-left"><?php echo e(__('STEP 3')); ?></span></div>
							</div>	
							<div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/user/templates/wizard/index.blade.php ENDPATH**/ ?>