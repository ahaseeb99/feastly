                ...
                <div class="collapse navbar-collapse section-links" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <?php if(config('frontend.features_section') == 'on'): ?>
                            <li class="nav-item">
                                <a class="nav-link scroll" href="/#info-banner"><?php echo e(__('Features')); ?></a>
                            </li>
                        <?php endif; ?>	
            ...
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <div class="text-center mb-9 mt-9 pt-7" id="contact-row">
                        ...
                        <p class="fs-12 text-center text-muted mb-5"><span><?php echo e(__('Please read Terms and Conditions before start using our website')); ?></p>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/service-terms.blade.php ENDPATH**/ ?>