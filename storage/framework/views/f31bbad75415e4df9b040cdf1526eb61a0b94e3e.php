					...
					<table id='prepaidAdminTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="10%"><?php echo e(__('OpenAI Model')); ?></th>									
									<th width="20%"><?php echo e(__('Words / DE Images / SD Images / Characters / Minutes')); ?></th>																																																																																																																																																																												
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/admin/finance/plans/prepaid/index.blade.php ENDPATH**/ ?>