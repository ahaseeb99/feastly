    ...
    <div class="container-fluid"> 
        <div class="d-flex">
            <a class="header-brand" href="<?php echo e(url('/')); ?>">
                ...
                <img src="<?php echo e(URL::asset('img/brand/logo-white.png')); ?>" class="header-brand-img desktop-lgo" alt="Feastly">
                <img src="<?php echo e(URL::asset('img/brand/favicon.png')); ?>" class="header-brand-img mobile-logo" alt="Feastly logo">
            ...
            <div class="d-flex order-lg-2 ml-auto"> 
                <div id="form-group">
                    <select id="template-selection" name="template-selection" class="top-form-select" data-placeholder="<?php echo e(__('New Cooking Content')); ?>" data-callback="changeTemplate">
...
<!-- END TOP MENU BAR -->
<?php /**PATH /home/u960948325/domains/feastly.co/public_html/resources/views/layouts/nav-top.blade.php ENDPATH**/ ?>