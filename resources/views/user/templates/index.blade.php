	...
	<div class="row mt-24">
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="border-0 templates-nav-header">
				<div class="card-body">
					<div>
						<h3 class="card-title mb-3 ml-2 fs-20 super-strong"><i class="fa-solid fa-book mr-2 text-primary"></i>{{ __('Cooking Templates') }}</h3>
						<h6 class="text-muted mb-3 ml-2">{{ __('Seeking that perfect recipe? Look no further! Get ready to explore our delicious lineup of cooking templates.') }}</h6>
						@if (config('settings.custom_templates') == 'anyone')
							<a href="{{ route('user.templates.custom') }}" class="btn btn-primary ripple" id="create-ai-button" style="text-transform: none;">{{ __('Create Custom Cooking Template') }}</a>
						@else
							@if ($check)
								<a href="{{ route('user.templates.custom') }}" class="btn btn-primary ripple" id="create-ai-button" style="text-transform: none;">{{ __('Create Custom Cooking Template') }}</a>
							@endif	
						...
						<div class="template-nav-menu-inner">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="true">{{ __('All Cooking Templates') }}</button>
								</li>
