...
<form id="wizard-form" action="" method="post" enctype="multipart/form-data" class="mt-24"> 		
	...
	<div class="row justify-content-center">	
		<div class="col-sm-12 text-center">
			<h3 class="card-title fs-20 mb-0 super-strong"><i class="fa-solid fa-kitchen-set mr-2 text-primary"></i>{{ __('Cooking Article Wizard') }}</h3>
					...
					<div class="row text-center justify-content-center">
						...
						<div class="col-3">
							<div class="d-flex wizard-nav-text">
								...
								<div class="wizard-step-title"><span class="font-weight-bold fs-14">{{ __('Points') }}</span> <br> <span class="text-muted wizard-step-title-number fs-11 float-left">{{ __('STEP 3') }}</span></div>
							</div>	
							<div>
