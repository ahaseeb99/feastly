	...
	<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">		
		...
		<div class="row justify-content-md-center">	
			<div class="col-sm-12 text-center">
				...
				<h6 class="mb-0 fs-12 text-muted">{{ __('Effortlessly sift through your recipes, manuals, and inventory lists in Word, PDF, or CSV formats with the aid of AI.') }}</h6>
								...
								<div id="chat-container">
									<div class="msg left-msg" id="intro-drop-box">
										...
										<div class="message-bubble">					
											<div class="msg-text">{{ __('Hello! I can help you sift through your recipes, manuals, and inventory lists in Word, PDF, or CSV formats. What details are you looking to find?') }}</div>
										</div>
									</div>
									<div id="image-drop-box">
										<div class="image-drop-area text-center">
											<div class="msg left-msg text-center mt-9">
												...
												<div class="message-bubble">					
													<div class="msg-text">{{ __('Hey there, ready to assist with analyzing your culinary documents. Share your files with me to begin!') }}</div>
													<div class="msg-text">{{ __('Select and upload your documents to get started, and let\'s dive into your culinary data!') }}</div>
												</div>
											</div>											
										</div>
									</div>
