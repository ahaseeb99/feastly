...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		<h4 class="page-title mb-0">{{ __('Restaurant Brand') }}</h4>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><i class="fa-solid fa-signature mr-2 text-primary"></i>{{ __('My Restaurant Brands') }}</h3>
					<a href="{{ route('user.brand.create') }}" class="btn btn-primary ripple" style="margin-left: auto">{{ __('Add New Restaurant') }}</a>
				</div>
