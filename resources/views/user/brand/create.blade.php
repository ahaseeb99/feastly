...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		<h4 class="page-title mb-0">{{ __('New Restaurant') }}</h4>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">	
				<div class="card-header">
					<h3 class="card-title"><i class="fa-solid fa-signature mr-2 text-primary"></i>{{ __('Restaurant Information') }}</h3>
					<a href="{{ route('user.brand') }}" class="btn btn-cancel mr-2 pl-5 pr-5" style="margin-left: auto">{{ __('Back to Restaurants List') }}</a>
				</div>			
						...
						<div class="row">	
							...
							<div class="col-lg-6 col-md-12 col-sm-12">													
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control @error('name') is-danger @enderror" id="name" name="name" placeholder="{{ __('Provide restaurant name') }}">
										@error('name')
							...
							<div class="col-lg-6 col-md-12 col-sm-12">													
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control @error('website') is-danger @enderror" id="website" name="website" placeholder="{{ __('Enter restaurant website URL') }}">
										@error('website')
							...
							<div class="col-lg-6 col-md-12 col-sm-12">													
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control @error('industry') is-danger @enderror" id="industry" name="industry" placeholder="{{ __('List your restaurant theme') }}">
										@error('industry')
							...
							<div class="col-lg-6 col-md-12 col-sm-12">													
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control @error('tagline') is-danger @enderror" id="tagline" name="tagline" placeholder="{{ __('Some ideas for your restaurant tagline') }}">
										@error('tagline')
							...
							<div class="col-lg-6 col-md-12 col-sm-12">													
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control @error('audience') is-danger @enderror" id="audience" name="audience" placeholder="{{ __('Describe the primary target audience for your restaurant') }}">
										@error('audience')
