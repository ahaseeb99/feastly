	...
	<div class="row mt-24">
		<div class="col-lg-12 col-md-12 col-sm-12 p-4">
			<div id="chat-search-panel">
				<h3 class="card-title mb-3 ml-2 fs-20 super-strong"><i class="fa-solid fa-comments mr-2 text-primary"></i>{{ __('AI Chefs') }}</h3>
				<h6 class="text-muted mb-3 ml-2">{{ __('Meet your AI Chefs! Get ready to discover our superb collection of culinary AI assistants.') }}</h6>
				...
				<div class="template-nav-menu-inner">
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="true">{{ __('All AI Chefs') }}</button>
						</li>
