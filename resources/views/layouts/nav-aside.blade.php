...
<li class="slide">
    <a class="side-menu__item" href="{{ route('user.templates') }}">
        ...
        <span class="side-menu__label">{{ __('Cooking templates') }}</span>
    </a>
</li> 
@if (config('settings.wizard_feature_user') == 'allow')
    <li class="slide">
        <a class="side-menu__item" href="{{ route('user.wizard') }}">
            ...
            <span class="side-menu__label">{{ __('Article Wizard') }}</span>
        </a>
    </li> 
@endif
...
<!--            <span class="side-menu__label">{{ __('Smart Editor') }}</span><span class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span>-->
<!--        </a>-->
<!--    </li> -->
<!--@endif-->
@if (config('settings.chat_feature_user') == 'allow')
    <li class="slide">
        <a class="side-menu__item" href="{{ route('user.chat') }}">
            ...
            <span class="side-menu__label">{{ __('Your AI Chefs') }}</span>
        </a>
    </li> 
@endif
@if (config('settings.chat_file_feature_user') == 'allow')
    <li class="slide">
        <a class="side-menu__item" href="{{ route('user.chat.file') }}">
            ...
            <span class="side-menu__label">{{ __('Kitchen AI FAQ') }}</span><span class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span>
        </a>
    </li> 
@endif
        @if (App\Services\HelperService::checkBrandsFeature())
            <li class="slide">
                ...
                <span class="side-menu__label">{{ __('Your Restaurants') }}</span></a>
            </li> 
        @endif 
        <li class="slide mb-3">
        ...
        <li class="slide">
            ...
            <span class="side-menu__label">{{ __('Payment Plans') }}</span></a>
        </li>
