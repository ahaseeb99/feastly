    ...
    <div class="container-fluid"> 
        <div class="d-flex">
            <a class="header-brand" href="{{ url('/') }}">
                ...
                <img src="{{URL::asset('img/brand/logo-white.png')}}" class="header-brand-img desktop-lgo" alt="Feastly">
                <img src="{{URL::asset('img/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Feastly logo">
            ...
            <div class="d-flex order-lg-2 ml-auto"> 
                <div id="form-group">
                    <select id="template-selection" name="template-selection" class="top-form-select" data-placeholder="{{ __('New Cooking Content') }}" data-callback="changeTemplate">
